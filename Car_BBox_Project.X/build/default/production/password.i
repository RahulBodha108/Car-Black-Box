...
void password(unsigned char key)
{
    ...
    if(pa_flag==1)
    {
        if(success==1)
        {
            clcd_print("Access Granted", (0x80 + (0)));
            clcd_print("****",(0xC0 + (0)));
            if(timeout==0)
            {
                clcd_write(0x01, 0);
        ...
        else if(success==0)
        {
            ...
            clcd_putch((unsigned char)attempts+48,(0xC0 + (15)));
            if(timeout==0)
            {
                pa_flag=0;
                clcd_write(0x01, 0);
    ...
    if(attempts==0)
    {
        clcd_print("Try after...", (0x80 + (0)));
        clcd_print("Retry in ", (0xC0 + (0)));
        clcd_putch(sec/100+48, (0xC0 + (9)));
        clcd_putch((sec%100)/10+48, (0xC0 + (10)));
    ...
    if(pass_index<4)
    {
        ...
        if(sec%2==0)
            clcd_putch('_',(0xC0 + (pass_index)));
        else
            clcd_putch(' ',(0xC0 + (pass_index)));
        if(key==11)
        {
            clcd_putch('*',(0xC0 + (pass_index)));
